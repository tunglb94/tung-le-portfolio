...
// Định nghĩa kiểu cho props translations
...
export default function HeroSection({ translations }: { translations: HeroTranslations }) {
  ...
  // Cập nhật lại contactLinks để dùng translations
  const contactLinks = [
    { 
      label: translations.cta_email, 
        ...
        <div className="flex flex-col justify-center order-2 md:order-1 text-center md:text-left">
          ...
          >
            <div className="flex items-center justify-center md:justify-start">
              ...
              {/* Sử dụng translations.contact_email */}
              <a href={`mailto:${translations.contact_email}`} className="text-gray-300 hover:text-white">
                {translations.contact_email}
              </a>
            </div>
            <div className="flex items-center justify-center md:justify-start">
              <Phone size={20} className="mr-2 text-cyan-400" />
              {/* Sử dụng translations.contact_phone */}
              <a href={`tel:${translations.contact_phone.replace(/\./g, '')}`} className="text-gray-300 hover:text-white">
